Style files control the formatting and presentation of \LaTeX documents. These are available as \emph{.sty} files for different journals, institutions, and other applications.
